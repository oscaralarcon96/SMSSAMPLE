...
public class admin_fragment_listview extends BaseAdapter {
    ...
    public admin_fragment_listview(Context context, int layout, ArrayList<String> names, ArrayList<String> names2){
